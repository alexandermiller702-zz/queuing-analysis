...
if __name__ == "__main__":
    ...
    data = csvRead.done("finalData.csv")[3]
    for i in range(len(data)):
        data[i] = data[i]+0.00001

    # done[3] = service, done [4] = ia times
    #alpha =  2.72319
    # IA
    alpha = 2.867
    loc = 0
...
print "The service chi_sq test value is %10.6f and the p-value is %10.6f" % (model(data, n, dof)[0], model(data,n,dof)[1])
